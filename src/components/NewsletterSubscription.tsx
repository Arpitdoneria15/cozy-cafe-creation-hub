        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
            <Input
              ...
              className="bg-white bg-opacity-10 border-white border-opacity-20 text-white placeholder:text-white placeholder:opacity-60"
            />
            <Button 
              type="submit"
              disabled={isSubmitting}
              className="bg-cafe-accent hover:bg-cafe-light hover:text-cafe-dark transition-colors"
            >
